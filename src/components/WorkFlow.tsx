...
const workflowSteps: WorkFlowStep[] = [
    {
        ...
        description:
            'Start with understanding your project needs, goals, and expectations. We align on the vision and set a solid foundation.'
    },
    {
        id: 2,
        title: 'Confirm Specs & Deadline',
        description:
            'Finalize the project specifications, scope, and establish a realistic timeline with key milestones to ensure transparency.'
    },
    {
        id: 3,
        title: 'Development',
        description:
            'Our team begins coding, designing, and implementing the agreed-upon features while ensuring high-quality performance and security.'
    },
    {
        id: 4,
        title: 'Integration',
        description:
            'We integrate the various components into a functional system, ensuring that different parts of the project work together seamlessly.'
    },
    {
        id: 5,
        title: 'Testing & Validation',
        description:
            'Before launching, we conduct thorough testing to identify and resolve any issues, ensuring a stable and polished final product.'
    },
    {
        id: 6,
        title: 'Completion & Delivery',
        description:
            'We deliver the final product with all necessary documentation, source code, and provide deployment assistance.'
    }
];
    ...
    return (
        <div className={`flex items-center w-full mx-auto ${alignmentClasses}`}>
            ...
            <div className="w-full md:w-1/2 md:px-8">
                <div
                    className={`p-6 rounded-lg bg-surface/75 backdrop-blur-lg border border-white/30 ${textAlignment}`}>
            ...
            {/* <!-- Center Point --> */}
            <div
                className={`absolute w-8 h-8 bg-primary rounded-full border-4 border-background z-10 hidden md:flex items-center justify-center ${pointAlignment}`}></div>
            {/* <!-- Empty Half --> */}
        ...
        <section className="py-20 sm:py-28" id={'workflow'}>
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div className="relative mt-16">
                    {/* <!-- Vertical Line --> */}
                    <div
                        className="absolute left-1/2 top-0 h-full w-0.5 bg-gray-700/50 hidden md:block"
